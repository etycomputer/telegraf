...
func (c *Config) getParserConfig(name string, tbl *ast.Table) (*parsers.Config, error) {
	...
	c.getFieldStringSlice(tbl, "csv_metadata_separators", &pc.CSVMetadataSeparators)
	c.getFieldString(tbl, "csv_metadata_trim_set", &pc.CSVMetadataTrimSet)
...
func (c *Config) missingTomlField(_ reflect.Type, key string) error {
	...
	case "alias", "carbon2_format", "carbon2_sanitize_replace_char", "collectd_auth_file",
		...
		"csv_timestamp_column", "csv_timestamp_format", "csv_timezone", "csv_trim_space", "csv_skip_values", "csv_metadata_rows", "csv_metadata_separators", "csv_metadata_trim_set",
